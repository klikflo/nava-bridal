  ...
  return (
    <header className="fixed top-0 w-full bg-background/98 backdrop-blur-md z-50 border-b border-border/50 shadow-sm">
      <div className="container mx-auto px-4 lg:px-6">
        <div className="flex items-center justify-between h-24 rtl">
          {/* Logo - Far Right */}
          <Link to="/" className="group order-1">
            <img
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="left" className="w-[320px] rtl bg-background/98 backdrop-blur-md">
              <div className="flex flex-col gap-8 mt-8">
                <div className="flex flex-col items-center justify-center mb-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground font-serif tracking-wide">House of Couture</p>
                </div>
                ...
                <nav>
                  <ul className="flex flex-col gap-4">
                    ...
                    <li>
                      <div className="text-center py-2 px-4 text-sm font-bold text-primary mb-2">
                        קולקציות
                      </div>
                      <div className="flex flex-col gap-3 px-2">
                        {collections.map((collection) => (
                          <Link
                            ...
                            className="group relative overflow-hidden rounded-xl border-2 border-border/30 hover:border-primary/50 transition-all duration-300"
                          >
                            {/* Image */}
                            <div className="relative h-32 overflow-hidden">
                              ...
                              <div className="absolute bottom-0 left-0 right-0 p-3 text-white">
                                <h3 className="text-base font-bold font-display mb-1 drop-shadow-lg text-center">
                                  {collection.nameHe}
                                </h3>
                    ...
                    {menuItems.map((item) => (
                      <li key={item.path}>
                        <Link
                          to={item.path}
                          onClick={() => setIsOpen(false)}
                          className={`block text-center py-3 px-4 text-base font-medium rounded-lg transition-all ${
                            isActive(item.path)
                ...
                <div className="flex items-center justify-center gap-8 mt-4 pt-6 border-t border-border">
                  <a
                    href="https://www.tiktok.com/@nava.bridal"
                    target="_blank"
                    rel="noopener noreferrer"
