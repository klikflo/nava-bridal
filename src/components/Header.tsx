...
const Header = () => {
  ...
  const menuItems = [
    ...
    { name: "קולקציות", path: "/collections" },
  ...
  return (
    <header className="fixed top-0 w-full bg-background/95 backdrop-blur-sm z-50 border-b border-border">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20 rtl">
          {/* Social Icons - Left */}
            ...
            <SheetContent side="right" className="w-[300px] rtl">
              <div className="flex flex-col gap-6 mt-8">
                ...
                <div className="text-center">
                  <h2 className="text-xl font-bold">NAVA BRIDAL</h2>
                    ...
                    {menuItems.map((item) => (
                      <li key={item.path}>
                        <Link
                          ...
                          className="block text-center py-2 text-base font-medium hover:text-primary transition-colors"
                        >
                          {item.name}
                        </Link>
                      </li>
